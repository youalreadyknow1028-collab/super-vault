...
### Mamaroneck Parks Department — Tectonic Survey Day
- **6:30 AM** — Nick arrived at Parks to meet Tectonic crew
- **Chris Posada (Tectonic Surveying)** on site with one additional crew member
- **7:30 AM** — Bob Camilli arrived on site
- Reviewed drawings with Bob to confirm elevations for Chris
- **Vertical Control:** Established benchmark on south wall of existing building (simplified from BFE due to elevation challenges on site)
- **Horizontal Control:** Set off-site control point near rocks above construction area to protect layout markers from equipment damage
- **Previously established points found:** 2 recovered — 1 was compromised
- **3 off-site control points set:**
  - Maple St in cul-de-sac near memorial
  - Myrtle Blvd south of fire hydrant
  - Baldwin Ave north facing curb
- **1 on-site control point** also established
- Tied new control points into existing topography using hardpoints: building corners, curbs, manhole covers, drainage structures
- **Decision made:** Simplified approach — benchmark on south wall instead of BFE (elevation challenges)
