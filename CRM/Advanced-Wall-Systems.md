---
uid: crm-Advanced-Wall-Systems
type: organization
role: Stucco / EIFS Contractor
...
| Contact | Role |
|---------|------|
| [[Andrew Luzzi]] | EIFS / Stucco — primary on site |

---

## PROJECT LINKS
- [[Yorktown DPW]] — EIFS (Exterior Insulation and Finish System) / Stucco installation
- [[Yorktown DPW Highway Garage]] — full exterior stucco system
...
- [[Craig]] (Roofer) NEEDS_STUCCO_BEFORE_METAL_TRIM ([[Advanced Wall Systems]] must finish first)

---

## 📍 PULSE — Organization Status
...
- **Hanover Electric:** Critical blocker — exterior lighting boxes/conduit must be installed before stucco base can be applied
- **Color approval:** Get Bob to approve stucco color sample ASAP so work can proceed
- **Roofer coordination:** Craig (roofer) needs stucco finished BEFORE he can do metal trim and emergency scupper metal work
- **NOTE:** Spruce Contracting does NOT perform EIFS/stucco work — this is Advanced Wall Systems' scope exclusively

---

## HASHTAGS
#AdvancedWallSystems #AWS #EIFS #Stucco #YorktownDPW #Construction #ExteriorFinish #AndrewLuzzi
