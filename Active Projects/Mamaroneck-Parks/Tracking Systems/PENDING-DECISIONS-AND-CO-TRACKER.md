...
**Last Full Update:** 2026-04-02 16:00 EDT (submittal data added from Autodesk CRM)  
...
- **Category:** PROJECTS
- **Path:** 1_Projects/Mamaroneck-Parks/Tracking-Systems/
- **Priority:** MEDIUM
- **Tags:** #mamaroneck-parks #pending-decisions #change-orders #super
...
| Field | Value |
|-------|-------|
| **Item** | Loft access ladder design |
| **Identified** | 2026-02-26 |
| **Source** | Meeting Minutes |
| **Status** | 🟡 PENDING DESIGN |
| **Action Needed** | Sarah/KGD design decision |

**History:**
- 2026-02-26: 🟡 IDENTIFIED — Design decision needed
- 2026-03-26: 🟡 STILL PENDING — Awaiting Sarah/KGD

---

## ✅ DEMOLITION COMPLETE — KEY MILESTONES

| Milestone | Date | Notes |
|-----------|------|-------|
| **Building Demolition** | 2026-03-16 to 2026-03-18 | Fully demolished |
| **Abatement** | 2026-03-25 | 100% COMPLETE (Insaren) |
| **Foundation Removal** | 2026-03-19 | Complete — debris cleared |
| **Temp Fence Reset** | 2026-03-16 | Blown down by wind, reset and re-sandbagged |
| **Containers/Dumpsters Removed** | 2026-03-19 to 2026-03-20 | 7 dumpsters gone, 2 more to pull |
| **Temp Water Active** | 2026-03-10 | Option 2: Seasonal Account #06534 |
| **Permit: Demolition** | 2026-03-10 | Issued |
| **Permit: Rock Removal** | 2026-03-24 | Issued |
| **Demolition Completion Letter** | 2026-03-24 | Received from Town |

**Demolition History:**
- 2026-03-10: ✅ DEMO PERMIT ISSUED
- 2026-03-10: ✅ TEMP WATER ACTIVE — WJWW activated service
- 2026-03-16: ✅ BUILDING DEMOLITION STARTED
- 2026-03-16: ✅ TEMP FENCE RESET — Blown down by wind, reset and re-sandbagged
- 2026-03-18: ✅ BUILDING DEMOLITION COMPLETE — Fully demolished
- 2026-03-19: ✅ FOUNDATION REMOVAL COMPLETE — Debris cleared
- 2026-03-19 to 2026-03-20: ✅ 7 DUMPSTERS/CONTAINERS REMOVED
- 2026-03-25: ✅ ABATEMENT 100% COMPLETE — Insaren
- 2026-03-24: ✅ ROCK REMOVAL PERMIT ISSUED
- 2026-03-24: ✅ DEMOLITION COMPLETION LETTER RECEIVED
- 2026-03-26: ✅ CONTAINERS PULLED — All 19 containers off site

---

## 🔧 BLOCKERS (ALL RESOLVED)

| Blocker | Trade | Status | Resolution Date |
|---------|-------|--------|----------------|
| Heavy concrete slowing abatement | Insaren | ✅ RESOLVED | 2026-03-25 |
| Mastro can't haul fast enough | Hauling | ✅ RESOLVED | 2026-03-20 |
| Fence blown down by wind | General | ✅ RESOLVED | 2026-03-16 |
...
|----------|---------|------|
| Abatement wrap-up pushed past Wednesday — new date TBD | Ivan/Insaren | 2026-03-27 |
| Foundation rest handled with excavator — no chipping hammerhead | Jose/United | 2026-03-27 |
| Up to six more dumpsters total needed | Ivan | 2026-03-27 |
| Construction Progress Meeting every two weeks | Mamaroneck Sign Shop | 2026-03-26 |

---

## ⏳ NEW ITEMS — ACTION REQUIRED

| Item | Trade | Priority | Status |
|------|-------|----------|--------|
| Pull two more containers from site | Hauling | 🔴 HIGH | ⏳ PENDING |
| Tectonic survey — Katarina Legener, Tue 8am | Survey | 🔴 HIGH | ⏳ PENDING |
| Construction Progress Meeting (Thu Mar 26) | Admin | 🔴 HIGH | ✅ DONE |
...
|------|------------|-----------|------------|--------|
| Temp water via restaurant | 2026-03-10 | Nick + Restaurant Owner | ✅ COMPLETED | ✅ DONE |
| E&SC installation sequence | 2026-03-11 | Nick + Crew | ✅ STANDARD | ✅ DONE |
...
## 🕸️ ONTOLOGY LINKS
- [[Nick Flanagan]] MANAGES [[Mamaroneck Parks]]
- [[Bob Camilli]] OWNS [[Peter Camilli & Sons]]
- [[Ritchie Price]] PROJECT_MANAGER [[Calgi Construction]]
- [[Erica Alvarez]] ENGINEER [[Tietjen Venelas Consulting Engineers]]
- [[Katarina Legener]] SURVEYING [[Mamaroneck Parks]]
- [[Ivan]] FOR [[Insaren]]
- [[Jose]] FOR [[United]]
